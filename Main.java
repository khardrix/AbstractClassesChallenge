...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //
        // The class will also need methods to move to the next item and back to previous item,
        // and methods to set the next and previous items.
        //
        // You should also specify a compareTo() that takes a parameter of the same type as the
